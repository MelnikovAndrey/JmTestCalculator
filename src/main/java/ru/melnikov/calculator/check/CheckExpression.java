package ru.melnikov.calculator.check;
...
public class CheckExpression {
    ...
    private void sizeList(List<String> list) throws IOException {
        if (list.size() != 3) {
            throw new IOException("Exception: Invalid expression, try entering \"5 * 6\" or \"VI + II\"");
        }
    }

    private void arithmeticOperations(List<String> list) throws IOException {
